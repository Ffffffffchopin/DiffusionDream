...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', help='path to config file',default="config/regression/mapfree/rot6d_trans_with_loftr.yaml")
    parser.add_argument('--checkpoint', help='path to model checkpoint', default='pretrained_models/far_loftr.ckpt')
    parser.add_argument('--img_path0', type=str, help='img path 0')
    parser.add_argument('--img_path1', type=str, help='img path 1')
    parser.add_argument('--k0', type=str, nargs='+',default="591.6007 591.6007 270.8742 351.5818")
    parser.add_argument('--k1', type=str, nargs='+',default="587.2150 587.2150 269.4281 351.9291")
    args = parser.parse_args()
    eval(args)
    #camera_pose_estimation(args.img_path0, args.img_path1)
